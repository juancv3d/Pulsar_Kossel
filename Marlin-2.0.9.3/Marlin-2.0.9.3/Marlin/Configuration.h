...
#define CUSTOM_MACHINE_NAME "Pulsar Kossel"
...
#define DELTA_HEIGHT 204.00 // (mm) Get this value from G33 auto calibrate
...
#define DELTA_RADIUS 77.72 // (mm) Get this value from G33 auto calibrate
